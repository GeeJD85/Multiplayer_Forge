...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerConnectionBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerConnectionNetworkObject)obj;
		...
		{
			Initialize(new PlayerConnectionNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerConnectionNetworkObject(networker, this, createCode, metadata);
		}
