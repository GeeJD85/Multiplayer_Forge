...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerNamePlateBehavior : NetworkBehavior
	{
		...
		public PlayerNamePlateNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerNamePlateNetworkObject)obj;
		...
		{
			Initialize(new PlayerNamePlateNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerNamePlateNetworkObject(networker, this, createCode, metadata);
		}
