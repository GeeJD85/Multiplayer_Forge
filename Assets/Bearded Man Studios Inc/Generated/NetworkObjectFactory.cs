			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case PlayerConnectionNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new PlayerConnectionNetworkObject(networker, id, frame);
						break;
					case PlayerControlNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new PlayerControlNetworkObject(networker, id, frame);
						break;
					case PlayerNamePlateNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new PlayerNamePlateNetworkObject(networker, id, frame);
						break;
